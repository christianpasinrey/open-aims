...
final class ProjectActivityTelegramFormatter
{
    ...
    private static function describe(string $kind, array $p): array
    {
        return match ($kind) {
            ...
            'milestone_updated' => ['🎯', 'Hito actualizado: <b>'.self::e((string) ($p['milestone_name'] ?? '—')).'</b>'],
            'milestone_completed' => ['🏁', 'Hito completado: <b>'.self::e((string) ($p['milestone_name'] ?? '—')).'</b>'],
            'milestone_reopened' => ['↩️', 'Hito reabierto: <b>'.self::e((string) ($p['milestone_name'] ?? '—')).'</b>'],
