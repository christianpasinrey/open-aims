...
<template>
    ...
    <h1 class="sr-only">GitHub integration</h1>
    ...
    <div class="flex flex-col space-y-8">
        ...
        >
            ...
            <span v-if="linkedCount !== null"
                >{{ linkedCount }} pull request(s) linked or updated.</span
            >
        </p>
        ...
        <section class="space-y-3">
            ...
            >
                Set <code class="font-mono">GITHUB_APP_ID</code>,
                <code class="font-mono">GITHUB_APP_NAME</code>,
                <code class="font-mono">GITHUB_APP_WEBHOOK_SECRET</code>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="text-[12px] text-muted-foreground">
                            Install the GitHub App on your organization to start
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="text-[12px] text-muted-foreground">
                            ...
                            · Installed {{ fmtDate(install.created_at) }}
                        </div>
                    </div>
                </div>
        ...
        <section class="space-y-3">
            ...
            <p class="text-[11.5px] text-muted-foreground">
                Read-only for now. Configured in
                <code class="font-mono">config/services.php</code> under
                <code class="font-mono">github_app.team_repo_map</code>.
            </p>
        </section>
                ...
                <table class="w-full text-[13px]">
                    ...
                    <tbody>
                        <tr
                            ...
                            class="border-b border-border last:border-b-0"
                        >
                            <td class="h-9 max-w-[280px] px-3 py-1.5">
                                <a
                                    :href="pr.url"
                                    target="_blank"
                            ...
                            <td class="h-9 max-w-[200px] truncate px-3 py-1.5">
                                <span
                            ...
                            <td class="h-9 px-3 py-1.5 text-muted-foreground">
